package dev.gmarques.compras.presenter.fragmentos.produto_io.add_produto
...
class AddProdutoViewModel : ViewModel() {
    ...
    internal val produto: Produto = Produto()
    ...
    suspend fun produtoJaExisteNaLista(nome: String) =
            ProdutoRepo.getProdutosNaListaPorNome(nome, listaId).isNotEmpty()
